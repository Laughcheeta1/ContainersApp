  ...
  return (
    <>
      <h1 className="search-page-title">
        ...
        Comodato Número {/*Nùmero del comodato */} <span className="Salida-Alquiler">Salida - Alquiler </span>
      </h1>

      <div className="container-resultados">
        <h2 style={{ fontSize: "26px" }}>Información general</h2>

        <span><span className="Titulo-info" style={{fontWeight:"bold"}}>- Persona que recibe: </span> Santiago Yepes Mesa</span>
        <span><span className="Titulo-info" style={{fontWeight:"bold"}}>- Dirección: </span> Calle 35 ...</span>
        <span><span className="Titulo-info" style={{fontWeight:"bold"}}>- Fecha: </span> 13/11/2023</span>
        <span><span className="Titulo-info" style={{fontWeight:"bold"}}>- Precio: </span> 4.000.000</span>
